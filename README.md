# Cloudflare Pages Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The Cloudflare Pages Trademarks Logo. They published a full and clear guidelines
for deployment and supplied some material files for it. However, its provided
...
This project re-draws Cloudflare Pages Trademarks Logo specifically for
1200x1200 size.
...
```
--------------------------------------------------------------------------------
Title: Cloudflare Pages Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-cloudflare-pages-1200x1200
UUID: 04CE9899-B14B-49FF-8D43-70EF230BD35F
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-01-15
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-cloudflare-pages-1200x1200
--------------------------------------------------------------------------------
```
